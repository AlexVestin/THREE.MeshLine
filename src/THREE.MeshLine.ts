...
export function MeshLineRaycast(
  ...
  if (index !== null && attributes !== null) {
    ...
    for (let i = 0, l = indices.length - 1; i < l; i += step) {
      ...
      const l = this.material.lineWidth;
      const width =
...
type GeometryType = Geometry | BufferGeometry | ArrayLike<number> | Vector3[];
...
export class MeshLine extends BufferGeometry {
  ...
  set geometry(value: BufferGeometry | Geometry) {
    this.setGeometry(value, this.widthCallback);
  }
